...
import { getFeatured, categories, avis } from "@/lib/data";

export default function HomePage() {
  const featured = getFeatured();
  const topAvis = avis[0];
    ...
    <div className="pb-nav">
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            ...
            <div key={stat.label} className="card px-3 py-4 text-center">
              <p className="font-display text-xl font-semibold text-terra-500 mb-0.5">
                {stat.valeur}
              </p>
              <p className="font-body text-[10px] text-brun-500 leading-tight">
                {stat.label}
              </p>
            </div>
          ))}
      ...
      <section className="mb-8">
        <div className="px-5 flex items-center justify-between mb-4">
          ...
          <Link href="/catalogue" className="font-body text-sm text-terra-500 font-medium">
            Tout voir
          </Link>
        </div>
            ...
            >
              ...
              <div className="p-3">
                ...
                <div className="flex items-center justify-between">
                  <span className="font-body text-xs font-semibold text-foret-600">
                    {creation.prix}
                  </span>
      ...
      <section className="px-5 mb-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/avis" className="font-body text-sm text-terra-500 font-medium">
            Tout voir
          </Link>
        </div>
        <div className="card p-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-body text-sm font-semibold text-brun-900">
                {topAvis.nom}
              </p>
              <p className="font-body text-xs text-brun-500">{topAvis.ville}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-5 mb-4">
        <div className="bg-terra-500 rounded-3xl p-6 text-center">
          ...
          <h3 className="font-display text-white text-xl font-semibold mb-4">
            Prêt à commander ?
          </h3>
          <Link href="/commande" className="inline-flex items-center gap-2 bg-white text-terra-600 font-body font-semibold text-sm px-6 py-3 rounded-2xl">
